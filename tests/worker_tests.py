...
from python3_gearman.errors import ServerUnavailable, InvalidWorkerState
from python3_gearman.protocol import get_command_name, GEARMAN_COMMAND_RESET_ABILITIES, GEARMAN_COMMAND_CAN_DO, GEARMAN_COMMAND_SET_CLIENT_ID, \
...
class WorkerTest(_GearmanAbstractWorkerTest):
    ...
    def test_registering_functions(self):
        ...
        self.assertEqual(sorted(self.command_handler._handler_abilities), ['fake_callback_one', 'fake_callback_two'])
