...
from python3_gearman.connection_manager import GearmanConnectionManager, NoopEncoder

from python3_gearman.constants import PRIORITY_NONE, PRIORITY_HIGH, PRIORITY_LOW, DEFAULT_GEARMAN_PORT, JOB_UNKNOWN, JOB_CREATED
from python3_gearman.errors import ConnectionError
from python3_gearman.job import GearmanJob, GearmanJobRequest
from python3_gearman.protocol import get_command_name
...
class MockGearmanConnectionManager(GearmanConnectionManager):
    ...
    def poll_connections_once(self, connection_map, timeout=None):
        return set(), set(), set()
