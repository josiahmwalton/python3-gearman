:mod:`python3_gearman.admin_client` --- Gearman Admin client
============================================================
.. module:: python3_gearman.admin_client
...
Checking server state::
    ...
    gm_admin_client = python3_gearman.GearmanAdminClient(['localhost:4730'])
