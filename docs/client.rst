:mod:`python3_gearman.client` --- Gearman client
================================================
.. module:: python3_gearman.client
...
.. automethod:: GearmanClient.submit_job
    ...
    Sending a simple job as a blocking call::
        ...
        # See python3_gearman.job.py to see attributes on the GearmanJobRequest
    ...
    Sending a high priority, background, blocking call::
       ...
       # See python3_gearman.job.py to see attributes on the GearmanJobRequest
       submitted_job_request = gm_client.submit_job("task_name", "arbitrary binary data", priority=python3_gearman.PRIORITY_HIGH, background=True)
...
Send/receive Python objects (not just byte strings)::
    ...
    class PickleDataEncoder(python3_gearman.DataEncoder):
        @classmethod
    ...
    class PickleExampleClient(python3_gearman.GearmanClient):
