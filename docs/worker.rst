:mod:`python3_gearman.worker` --- Gearman worker
================================================
.. module:: python3_gearman.worker
...
Send/receive Python objects and do work between polls::
    ...
    class JSONDataEncoder(python3_gearman.DataEncoder):
        @classmethod
    ...
    class DBRollbackJSONWorker(python3_gearman.GearmanWorker):
